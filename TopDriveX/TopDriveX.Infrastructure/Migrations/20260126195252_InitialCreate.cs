        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Bulgaria"),
                    DealershipName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DealershipAddress = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationFrequencyHours = table.Column<int>(type: "int", nullable: false, defaultValue: 24),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyStyle = table.Column<int>(type: "int", nullable: true),
                    Condition = table.Column<int>(type: "int", nullable: false),
                    EngineSize = table.Column<decimal>(type: "decimal(4,1)", nullable: true),
                    HorsePower = table.Column<int>(type: "int", nullable: true),
                    Cylinders = table.Column<int>(type: "int", nullable: true),
                    Color = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    InteriorColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisements_IsFeatured",
                table: "Advertisements",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisements_PublishedAt",
                table: "Advertisements",
                column: "PublishedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisements_UserId_Status",
                table: "Advertisements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_MakeId_ModelId",
                table: "Vehicles",
